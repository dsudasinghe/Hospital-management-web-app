...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 25, 2021 at 07:33 AM
...
INSERT INTO `doctor` (`docid`, `doc_nic`, `docfirstname`, `doclastname`, `specialization`, `availabledays`, `availabletimes`, `aboutme`) VALUES
...
INSERT INTO `patiant` (`id`, `username`, `email`, `password`, `bloodgroup`, `allergy`, `dob`, `firstname`, `lastname`) VALUES
